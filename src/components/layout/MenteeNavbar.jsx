...
function MenteeNavbar({ onMenuClick }) {
  return (
    <header className="h-16 w-full flex-shrink-0 flex items-center justify-between gap-4 px-4 sm:px-6 bg-[#0D1220] border-b border-slate-800/80 sticky top-0 z-30">
      ...
      <div className="flex flex-shrink-0 items-center gap-1.5 sm:gap-2">
        ...
        <div className="flex items-center gap-2 pl-1">
          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-purple-600 text-[11px] font-bold text-white">
            FS
          </div>

          <div className="hidden lg:block max-w-[180px] leading-tight">
